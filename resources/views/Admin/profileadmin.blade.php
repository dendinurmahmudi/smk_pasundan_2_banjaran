		...
		<div class="tab-content">
			<div class="white-box">                        
				...
				<div class="row">
					<div class="col-sm-12">
						<hr>
						<form class="form-material" action="editprofileadmin" method="POST" enctype="multipart/form-data">
							{{ csrf_field() }}
			...
			<div class="tab-content">
				<div class="white-box">                        
					...
					<div class="row">
						<div class="col-sm-12">
							<hr>
							<form class="form-material" action="/editprofileadmin" method="POST">
								{{ csrf_field() }}
							...
							<div class="modal-content">
								<div class="modal-header">
									...
									<div class="modal-body">
										<div class="white-box">
											<form action="/gantipass2" enctype="multipart/form-data" method="post">
												{{ csrf_field() }}
												<div class="row">
