    ...
    <div style='max-width: 700px; padding:50px 0;  margin: 0px auto; font-size: 14px'>
      ...
      <div style='padding: 40px; background: #fff;'>
        <table border='0' cellpadding='0' cellspacing='0' style='width: 100%;'>
          <tbody>
            <tr>
              <td style='border-bottom:1px solid #f6f6f6;'><h1 style='font-size:14px; font-family:arial; margin:0px; font-weight:bold;'>Kepada {{$email}}</h1>
              ...
              <tr>
                ...
                <tr>
                  <td  style='border-top:1px solid #f6f6f6; padding-top:20px; color:#777'>Jika tombol diatas tidak berfungsi, silahkan tanya kan permasalahan melalui admin. Dan jika ada masalah berlanjut silahkan hubungi careerdevcenter.smkpasundan@gmail.com</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div style='text-align: center; font-size: 12px; color: #b2b2b5; margin-top: 20px'>
            <p> Powered by Themedesigner.in <br>
              <a href='' style='color: #b2b2b5; text-decoration: underline;'></a> </p>
            </div>
          </div>
        </div>
      </body>
